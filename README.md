...
![Fraud Rate by Transaction Type](Docs/typeoutput.png)
...
![ New Balance vs Amount Scatter](Docs/output.png)

![Old Balance vs Amount Scatter](Docs/image.png)
...
![Step Over Time](Docs/stepoutput.png)
